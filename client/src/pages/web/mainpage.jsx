...
const MainPage = () => {
  ...
  return (
    <Grid container sx={{ height: "100vh" }} maxWidth="lg">
      <Grid item xs={3} sx={{ height: "100vh", backgroundColor: "#2D4356" }} maxWidth="lg">
        ...
        >
          <ListItemButton
            ...
            sx={{ fontSize: "10px", ...(open1 && { backgroundColor: "rgba(255, 255, 255, 0.1)" }) }}
          >
            <ListItemIcon>
        ...
        >
          <ListItemButton
            ...
            sx={{ fontSize: "10px", ...(open2 && { backgroundColor: "rgba(255, 255, 255, 0.1)" }) }}
          >
            <ListItemIcon>
      ...
      <Grid item xs={9} sx={{ height: "100vh" }} maxWidth="lg">
        <Box sx={{ width: "100%" }}>
          <Paper sx={{ width: "100%", mb: 2, mt: 8, ml: 5 }}>
            <EnhancedTableToolbar numSelected={selected.length} />
            <TableContainer>
              <Table
                sx={{ minWidth: 750, "& thead th": { backgroundColor: "#2D4356", color: "white" } }}
