    ...
    while True:
        ...
        if repeat == 20:
            ...
            if 1 in nowParking:
                ...
                try:
                    requests.post(exit_url, data=json_data, headers=headers)
                            ...
                            if int(mostRecentSonar) < 30:
                                ...
                                if nowParking[mostFrequentMacIndex] == 0:
                                    ...
                                    try:
                                        ...
                                        print(nowParking[mostFrequentMacIndex])
                                        print('car_in')
                                        requests.post(parking_url, data=json_data, headers=headers, timeout=1)
                                        try:
                                            requests.post(soundModuleUrl, data=json_data, headers=headers, timeout=1)
                                        except Exception as e:
